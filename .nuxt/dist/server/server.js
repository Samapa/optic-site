...
/******/ 			var chunk = require("./" + ({"1":"pages/contact","2":"pages/index","3":"pages/message","4":"pages/partners","5":"pages/players","6":"pages/teamsummertime"}[chunkId]||chunkId) + ".js");
...
/******/ 	__webpack_require__.p = "/optic-livesite/_nuxt/";
/******/
...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, ":root{--optic-green:#9dc73b;--tst-blue:#5f8ebf;--primary:#fff;--invert:#1c1b1b}h1,h2,h3{font-family:\"Roboto\",sans-serif;margin:0;padding:0;font-size:16px;text-transform:uppercase;letter-spacing:5px}a,div,input,li,p,ul{font-family:\"Noto Sans JP\",sans-serif;margin:0;padding:0;font-size:11px;letter-spacing:2px;text-decoration:none;color:#1c1b1b;color:var(--invert)}input,textarea{width:100%;background:transparent;border:1px solid var(--primary);height:30px;border:1px solid rgba(0,0,0,.2);margin-top:5px;padding:7px;transition:.3s ease}textarea{height:150px;transition:.3s ease}input:focus,textarea:focus{outline:none;border:1px solid #9dc73b;border:1px solid var(--optic-green);transition:.3s ease}.flex{display:flex;flex-direction:column}.backgroundf3{background-color:#f3f3f3}.invert-font{color:#fff;color:var(--primary)}.optic-title{text-align:center;font-size:30px;padding:40px 0}.optic-btn{text-align:center;font-size:16px;font-weight:700;text-transform:uppercase;background-color:#1c1b1b;background-color:var(--invert);color:#fff;color:var(--primary);transition:.3s ease;padding:5px;margin-top:5px}.optic-btn:hover{background-color:#9dc73b;background-color:var(--optic-green);transition:.3s ease}@media only screen and (max-width:1024px){.optic-container{padding:0 20px}.mobile-hidden{display:none}}@media only screen and (min-width:421px){.optic-container{padding:0 50px}}", ""]);
// Exports
module.exports = exports;
...
const _65f80dde = () => interopDefault(__webpack_require__.e(/* import() | pages/contact */ 1).then(__webpack_require__.bind(null, 75)));

const _2f7d9e45 = () => interopDefault(__webpack_require__.e(/* import() | pages/message */ 3).then(__webpack_require__.bind(null, 76)));

const _1a30bf5d = () => interopDefault(__webpack_require__.e(/* import() | pages/partners */ 4).then(__webpack_require__.bind(null, 77)));

const _f46edb20 = () => interopDefault(__webpack_require__.e(/* import() | pages/players */ 5).then(__webpack_require__.bind(null, 78)));

const _c5e6556a = () => interopDefault(__webpack_require__.e(/* import() | pages/teamsummertime */ 6).then(__webpack_require__.bind(null, 79)));

const _5b39fb10 = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 2).then(__webpack_require__.bind(null, 74))); // TODO: remove in Nuxt 3
...
var assets_global = __webpack_require__(19);
...
const createNext = ssrContext => opts => {
  ...
  const routerBase = '/optic-livesite/';
